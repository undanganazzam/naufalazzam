      ...
      h = function (t) {
        ...
        (n = function () {
          var t,
            ...
            e,
            g = function () {
              (c = parseInt(u / 86400, 10)), (u %= 86400), (d = parseInt(u / 3600, 10)), (u %= 3600), (p = parseInt(u / 60, 10));
            };
          (l = new Date()),
            w.enableUtc ? ((i = new Date(l.getFullYear(), l.getMonth(), l.getDate(), l.getHours(), l.getMinutes())), (u = (r - i.getTime()) / 1e3)) : (u = (r - l.getTime()) / 1e3),
            u > 0 ? g() : w.countUp ? ((u = (l.getTime() - r) / 1e3), g()) : ((c = 0), (d = 0), (p = 0), window.clearInterval(s), w.onEnd()),
            w.plural
            ...
            w.inline
              ? (o.innerHTML = ''.concat(c, ' ').concat(t, ', ') + ''.concat(d, ' ').concat(n, ', ') + ''.concat(p, ' ').concat(e, '.'))
